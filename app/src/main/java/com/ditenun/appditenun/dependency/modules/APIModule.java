...
//    public static final
//    String ACCESS_TOKEN_TEMP = "$2y$10$CsRsRjzxICKa6h.bzLqRTuum6u2XhVq4R47CG0TgVDI8axdQJW5ne";

    //Verfikasi Kualitas Gambar dan klasifikasi ulos
    private static Retrofit retrofit;
    private static final String VERandKLAS_URL = "http://mobile.ditenun.com/";
    ...
    //Retrofit for Verifikasi Kualitas Gambar dan klasifikasi ulos
    public static Retrofit getRetrofitVerandKlasInstance() {
        if (retrofit == null) {
            retrofit = new retrofit2.Retrofit.Builder()
                    .baseUrl(VERandKLAS_URL)
